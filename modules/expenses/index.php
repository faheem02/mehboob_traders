...
<div class="row mb-3">
  <div class="col-lg-5">
    <div class="card shadow">
      <div class="card-header"><h6><i class="fas fa-plus-circle"></i> Add Expense</h6></div>
      <div class="card-body">
        <form method="post">
          <div class="row">
            ...
            <div class="col-md-12 mb-2" id="bankDiv" style="display:none;">
            ...
            <div class="col-md-12">
              <button type="submit" class="btn btn-danger btn-block"><i class="fas fa-save"></i> Save Expense</button>
            </div>
          </div>
        </form>
      </div>
  ...
  <div class="col-lg-7">
    <div class="card shadow">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h6><i class="fas fa-file-invoice-dollar"></i> Expense List (<?=count($expenses)?>)</h6>
      </div>
      <div class="card-body">
        <form method="get" class="row g-2 mb-3">
          ...
          <div class="col-md-2"><button class="btn btn-outline-primary btn-block"><i class="fas fa-filter"></i> Go</button></div>
        </form>

        <div class="alert alert-info py-2 text-center"><strong>Filtered Total: PKR <?=formatCurrency($total_expense)?></strong></div>
          ...
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><span class="badge badge-secondary"><?=ucfirst($e['payment_method'])?></span></td>
...
<script>
$(document).ready(function(){ $('#payMethod').change(function(){ $('#bankDiv').toggle(this.value === 'bank'); }); });
</script>
